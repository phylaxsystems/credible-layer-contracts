...
contract DeployCoreWithStaging is DeployCore {
    ...
    function setUp() public override {
        ...
        stagingMaxAssertionsPerAA = uint16(
            vm.envUint("STAGING_STATE_ORACLE_MAX_ASSERTIONS_PER_AA")
        );
        stagingAssertionTimelockBlocks = uint128(
            vm.envUint("STAGING_STATE_ORACLE_ASSERTION_TIMELOCK_BLOCKS")
        );
    ...
    function run() public override broadcast {
        ...
        address stagingOracle = _deployStateOracle(
            daVerifier,
